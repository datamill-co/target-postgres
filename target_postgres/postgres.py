...
class PostgresTarget(SQLInterface):
    ...
    def _get_update_sql(self, target_table_name, temp_table_name, key_properties, columns, subkeys):
        ...
        for pk in key_properties:
            ...
            pk_temp_select_list.append(sql.SQL('{}.{}').format(full_temp_table_name, pk_identifier) + '::varchar')
            pk_temp_select_dedupped_list.append(sql.SQL('"dedupped".{}').format(pk_identifier) + '::varchar')
